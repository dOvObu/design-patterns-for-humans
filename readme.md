...
||[Прокси](#-proxy)|[Посититель](#-visitor)|
|||[Стратегия](#-strategy)|
|||[Состояние](#-state)|
...
* [Шаблоны Создания](#creational-design-patterns)
 ...
 * [Тупа Фабрика](#-simple-factory)
 * [Фабричныей Метод](#-factory-method)
 * [<i>Абстрактная Фабрика</i>](#-abstract-factory)
 * [Строитель](#-builder)
 * [Прототип](#-prototype)
 * [Мемный Синглтон](#-singleton)
